...
export const RegisterForm = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <div className="flex-1 flex items-center justify-center bg-green-900 p-6">
                <div className="bg-white text-gray-800 p-8 rounded-lg shadow-lg w-full max-w-sm">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            />
                            <label htmlFor="terms" className="text-sm text-gray-600">J'accepte les <Link to="#" className="text-green-600 hover:underline">termes et conditions</Link></label>
                        </div>
                        {errorMessage && (
            ...
            <footer className="bg-green-800 text-white p-4 w-full mt-auto">
